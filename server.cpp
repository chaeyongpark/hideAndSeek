...
// First one is tagger second one is runner
// Remain coordinate is trash objects
void Server::randGen() {
	struct position r;
	int num = 0;
	srand(time(NULL));
